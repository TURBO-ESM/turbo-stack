...
void tripolar_vy_sync_valid(MultiFab& v, Geometry const& geom)
{
    ...
    struct IndexMapping
    {
        ...
        [[nodiscard]] Dim3 operator()(Dim3 i) const noexcept { return {nx - 1 - i.x, i.y, i.z}; }

        [[nodiscard]] Dim3 Inverse(Dim3 i) const noexcept { return {nx - 1 - i.x, i.y, i.z}; }

        [[nodiscard]] constexpr IndexType operator()(IndexType it) const noexcept { return it; }
...
void tripolar_vy_fill_ghost(MultiFab& v, Geometry const& geom)
{
    ...
    struct IndexMapping
    {
        ...
        [[nodiscard]] Dim3 operator()(Dim3 i) const noexcept { return {nx - 1 - i.x, 2 * ny - i.y, i.z}; }

        [[nodiscard]] Dim3 Inverse(Dim3 i) const noexcept { return this->operator()(i); }
...
void tripolar_vx_fill_ghost(MultiFab& u, Geometry const& geom)
{
    ...
    struct IndexMapping
    {
        ...
        [[nodiscard]] Dim3 operator()(Dim3 i) const noexcept { return {nx - i.x, i.y - 1, i.z}; }

        [[nodiscard]] Dim3 Inverse(Dim3 i) const noexcept { return {nx - i.x, i.y + 1, i.z}; }
